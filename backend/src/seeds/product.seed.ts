...
export const seedProducts = async (
  ...
  for (let i = 1; i <= 15; i++) {
    ...
    const randomBrand =
      brandEntities[Math.floor(Math.random() * brandEntities.length)];
      ...
      keyFeatures: [
        {
          ...
          subtitle: '手工磨利刀刃',
          description:
            '金屬刀刃經過多重手工磨利處理，磨出專業高精度切割角度，讓切割更加輕鬆精準。',
        },
        {
          ...
          subtitle: '特注高硬性鋼',
          description:
            '刀具使用高級 7Cr17 不鏽鋼，保證刀刃長時防鏽、耐磨損、不影響食物味道。',
        },
        {
          image: 'https://picsum.photos/seed/knife-handle/500/300',
          title: '人體工學設計',
          description:
            '特別設計的手柄適合各種手型，完美重量平衡、握感舒適，長時間使用也不疲勞。',
        },
      ],
      featureDetails: [
        {
          ...
          title: '精準切割體驗',
          description:
            '刀刃採用特殊角度設計，切割時更加順暢，無論是切肉、切菜還是切水果，都能保持精準的切割線條，讓烹飪更加專業。',
          direction: 'left',
        },
        {
          type: 'image',
          ...
          title: '特殊鋼材工藝',
          description:
            '採用德國進口特殊鋼材，經過多道熱處理工序，刀刃硬度達到HRC58度，保持鋒利的同時兼具韌性，不易崩刃。',
          direction: 'right',
        },
        {
          type: 'image',
          ...
          title: '人體工學手柄',
          description:
            '手柄採用高級樹脂材料，經過人體工學設計，握感舒適，長時間使用不疲勞，同時防滑設計確保使用安全。',
          direction: 'left',
        },
      ],
      isActive: true,
      ...
      keyFeatures: [
        {
          ...
          subtitle: '可持續林場認證',
          description:
            '使用經FSC認證的可持續林場木材，材質堅固耐用，確保環保與品質兼具。',
        },
        {
          ...
          subtitle: '極簡主義設計',
          description:
            '簡潔直線條趨勢設計，各種家居風格適用，不限時間和種空間。',
        },
        {
          image: 'https://picsum.photos/seed/shelf-adjust/500/300',
          title: '可調節層板',
          description:
            '書架層板高度可自由調節，適應不同高度的書籍和裝飾品，靈活運用空間。',
        },
      ],
      featureDetails: [
        {
          ...
          title: '北歐設計美學',
          description:
            '採用北歐簡約設計風格，線條簡潔流暢，色彩柔和自然，為居家環境增添現代感與溫馨氛圍，適合各種裝修風格。',
          direction: 'left',
        },
        {
          type: 'image',
          ...
          title: '環保材質選擇',
          description:
            '全部採用FSC認證的可持續林場木材，不含有害物質，環保健康，同時具有優良的耐用性和穩定性，使用壽命長。',
          direction: 'right',
        },
        {
          type: 'video',
          ...
          title: '簡易安裝示範',
          description:
            '創新的卡扣式設計，無需複雜工具即可輕鬆完成安裝，附帶詳細安裝說明書和視頻教學，讓您輕鬆搞定。',
          direction: 'left',
        },
      ],
      isActive: true,
      ...
      keyFeatures: [
        {
          ...
          subtitle: '自動溫度調節',
          description:
            '內置小型智能溫控芯片，可保持飲料在 60-85°C 的最佳飲用溫度，適合咖啡茶等。',
        },
        {
          ...
          subtitle: '智能節能模式',
          description:
            '針對不同用戶需求，開發了多種節能模式，最長可達 8 小時的使用時間，通勤到公司無憂杯。',
        },
        {
          image: 'https://picsum.photos/seed/mug-material/500/300',
          title: '高級別瓷器',
          description:
            '杯身多層高級別食品安全瓷器，隔熱不燙手材質，外部觸摸無燙傷，隔空。多彩五色可選。',
        },
      ],
      isActive: true,
    },
