...
const updateFAQs = async () => {
  try {
    ...
    const commonFAQTemplates = [
      {
        question: '這個產品有保固嗎？',
        answer:
          '是的，我們提供一年的標準保固，涵蓋材料和製造缺陷。您也可以選擇購買延長保固計劃。',
      },
      {
        question: '如何正確清潔和保養這個產品？',
        answer:
          '建議使用溫和的清潔劑和軟布進行清潔，避免使用研磨性清潔工具。詳細的保養指南可以在產品手冊中找到。',
      },
      {
        question: '產品尺寸是多少？',
        answer:
          '產品的具體尺寸請參考產品規格表。如果您有特殊需求，也可以聯繫我們的客服人員獲取更詳細的資訊。',
      },
      {
        question: '可以退貨嗎？',
        answer:
          '是的，我們提供30天無條件退貨服務。產品必須保持原始狀態，並附帶所有包裝和配件。',
      },
      {
        question: '運送需要多長時間？',
        answer:
          '一般情況下，國內訂單會在1-3個工作日內發貨，配送時間約為3-5個工作日。國際訂單可能需要7-14個工作日。',
      },
    ];
      ...
      廚房用品: [
        {
          ...
          answer:
            '大部分我們的廚具都是洗碗機安全的，但請查看產品標籤上的具體說明。某些特殊材質或設計可能需要手洗。',
        },
        {
          question: '這個廚具可以用於電磁爐嗎？',
          answer:
            '是的，我們的大多數廚具都適用於各種爐具，包括電磁爐。產品描述中會標明兼容的爐具類型。',
        },
      ],
      浴室用品: [
        {
          question: '這個產品防水嗎？',
          answer:
            '我們的浴室用品都有一定程度的防水設計，但防水等級可能有所不同。請參考產品規格中的防水等級說明。',
        },
        {
          question: '如何安裝這個浴室配件？',
          answer:
            '大多數浴室配件都附帶詳細的安裝說明。一般來說，您只需要基本的工具就可以完成安裝。如有困難，也可以聯繫專業安裝服務。',
        },
      ],
      臥室用品: [
        {
          ...
          answer:
            '我們的床上用品使用多種高品質材料，包括棉、麻、絲綢等。具體材質請參考產品描述或標籤。',
        },
        {
          question: '這個床上用品可以機洗嗎？',
          answer:
            '大多數床上用品都可以機洗，但請按照產品標籤上的洗滌說明操作，以確保產品的壽命和品質。',
        },
      ],
      客廳用品: [
        {
          ...
          answer:
            '部分家具需要簡單組裝，我們會提供所有必要的工具和詳細的組裝說明。大型家具可能提供專業組裝服務，詳情請諮詢客服。',
        },
        {
          question: '這個家具的承重能力是多少？',
          answer:
            '不同家具的承重能力各不相同，請參考產品規格中的承重參數。超過承重限制可能會損壞產品並造成安全隱患。',
        },
      ],
      辦公用品: [
        {
          ...
          answer:
            '是的，我們的大多數辦公椅都提供高度調節功能，部分型號還有其他調節選項，如扶手高度、靠背角度等。',
        },
        {
          question: '這個辦公桌有線材管理系統嗎？',
          answer:
            '部分辦公桌型號配備了線材管理系統，幫助整理和隱藏電線。具體功能請參考產品描述或諮詢客服。',
        },
      ],
    };
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      const shuffledCommonFAQs = [...commonFAQTemplates].sort(
        () => 0.5 - Math.random(),
      );
      productFAQs = productFAQs.concat(
        shuffledCommonFAQs.slice(0, commonFAQCount),
      );
      ...
      console.log(
        `已更新產品 ${product.id} 的 faqs，添加了 ${productFAQs.length} 個問答`,
      );
    }
